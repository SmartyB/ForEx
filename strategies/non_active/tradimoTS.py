...
class TradimoTS(Strategy, lib.Event):
    ...
    def makeOrder(self):
        ...
        if side:
            ...
            self.createOrder(side, amount, entry=entry, stopLoss=sl, takeProfit=tp.value, trailingStop=10, riskClosePips=5, expiry=1800)
